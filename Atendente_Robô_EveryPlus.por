...
programa
{
	...
	funcao inicio()
	{
		...
		inteiro masculino=1,feminino=2,neutro=3,outro=3,protocolo,origem_real,origem_site
		...
		//Define a entrada de origem do contato
		cadeia origem[][]={{"Whatsapp"},{"Telegram"},{"E-mail"},{"Formulário Site"},{"Facebook"},{"Instagram"}}
		cadeia home_site[][]={{"HomePage"},{"Contato"},{"Curricullum"}}
		origem_real=u.sorteia(1,6)
		origem_site=u.sorteia(1,3)
		//escreva(origem[origem_real-1][lista])

		
				escreva("Bem vindo(a) ao EveryPlus Chat" + "\n")
				escreva("\n" + "Ao entrar em contato conosco, você declara ter lido e concordado com a nossa Política de Privacidade e Proteção de Dados e com os nossos Termos de Uso" + "\n")
				u.aguarde(2000)
	...
	// 2 - FALTA INCLUIR
		// a. Atendimento em horário comercial | b. Envio de histórico, protocolo e dados coletados para o e-mail do usuário com cópia ao atendente
		// [CONCLUIDO]c. Informa qual canal/origem do usuário (telegram, site, whatsapp ou e-mail) | d. armazena os dados do usuário em bancoo de dado
		// e. pede autorização para coletar, tratar e armazenas os dados do usuário (primeira coisa) -> cria um link do diretório onde os dados do usuáraaio estão e envia para ele para que ele possa consultá-las [Exemplo na linha de baixo]
			
			//Ex.:       	  	 http://everplus.rosemberg.com.br/user51654984651/26-06-2021/01-52-53/ip-sha1&ssl
			//Detalhamento =	protocolo//link/nick_do_email+protocolo_de_atendimento/data/hora/ip-tipos_de_identificacao_no_diretorio
					//porta1A	http://everplus.rosemberg.com.br/pedrorosembergdev3633928200010110332519686/29-06-2021/01-56-20/ip-sha1&ssl&ete.phpx

					escreva ("\n" + "O histórico desta conversa será enviada para você por e-mail." + "\n")
					escreva("http://everplus.rosemberg.com.br/pedrorosembergdev3633928200010110332519686/29-06-2021/01-56-20/ip-sha1&ssl&ete.phpx")

					//Copyright (c) 2021 PEDRO PAULO ROSEMBERG DA SILVA OLIVEIRA 
					//Copyright (c) 2021 PEDRO ROSEMBERG MARKETING E TECNOLOGIA SA
					//
